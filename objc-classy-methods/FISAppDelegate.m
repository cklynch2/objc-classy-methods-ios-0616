...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    NSDictionary *classyByInit = [[NSDictionary alloc] initWithObjectsAndKeys: classyPeople, @"classy people",  classyThings, @"classy things", classyDrinks, @"classy drinks", nil];
    NSLog(@"%@", classyByInit);
